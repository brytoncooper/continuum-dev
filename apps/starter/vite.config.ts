...
const continuumSourceAliases = {
  ...
  '@continuum-dev/core': resolve(__dirname, '../../packages/core/src/index.ts'),
  '@continuum-dev/prompts': resolve(
    __dirname,
    '../../packages/prompts/src/index.ts'
  ),
  '@continuum-dev/react': resolve(__dirname, '../../packages/react/src/index.ts'),
