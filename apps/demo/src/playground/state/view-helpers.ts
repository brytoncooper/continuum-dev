...
function collectScopedNodeIds(nodes: ViewNode[], parentNodeId?: string): string[] {
...
function findScopedNodeId(nodes: ViewNode[], trackedKey: string, parentNodeId?: string): string | null {
...
export function findScopedNodeIdByKey(view: ViewDefinition, trackedKey: string): string | null {
...
export function findScopedNodeIdsByKey(
  ...
  return Object.fromEntries(
    trackedKeys.map((trackedKey) => [trackedKey, findScopedNodeIdByKey(view, trackedKey)])
