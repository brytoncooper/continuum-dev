...
export const financialPlanningSessionActions = {
  'client.profile.save': {
    registration: {
      label: 'Save profile',
      description:
        'Persist household and contact fields for PUT /api/v1/clients/me/profile.',
    },
  ...
  'goals.retirement.save': {
    registration: {
      ...
      description:
        'Persist retirement goal snapshot for POST /api/v1/goals/retirement.',
    },
    handler: demoActionHandler,
  },
  'cashflow.monthly.save': {
    registration: {
      ...
      description:
        'Persist income and expense snapshot for POST /api/v1/cashflow/monthly.',
    },
    handler: demoActionHandler,
  },
  'risk.profile.save': {
  ...
  'documents.metadata.save': {
    registration: {
      ...
      description:
        'Persist document metadata for POST /api/v1/documents/metadata.',
    },
    handler: demoActionHandler,
  },
} as const;
