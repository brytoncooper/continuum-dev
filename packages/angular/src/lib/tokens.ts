...
export const CONTINUUM_SESSION = new InjectionToken<Session>('CONTINUUM_SESSION');
export const CONTINUUM_SNAPSHOT = new InjectionToken<Signal<ContinuitySnapshot | null>>(
  'CONTINUUM_SNAPSHOT'
);
export const CONTINUUM_NODE_MAP =
