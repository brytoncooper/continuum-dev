...
export function buildTransformSystemPrompt(): string {
  return [
    ...
    'Prefer the smallest continuity plan that faithfully preserves user meaning through the structural change.',
...
export function buildTransformUserMessage(args: {
  ...
  return [
    ...
    '- Stay within continuity-aware structural refactoring. Do not answer with value-only updates or a full authored view.',
    '',
    'Selected targets:',
