...
import { type ContinuumChatAttachment, type ContinuumExecutionAdapter, type ContinuumExecutionContext, type ContinuumExecutionFinalResult, type ContinuumExecutionRequest, type ContinuumViewAuthoringFormat } from '@continuum-dev/ai-engine';
...
import type { ContinuumVercelAiSdkExecutionTraceData, ContinuumVercelAiSdkMessage } from './lib/types.js';
 ...
 */
export declare function extractChatAttachmentsFromMessages(messages: ContinuumVercelAiSdkRouteRequestBody['messages']): ContinuumChatAttachment[];
/**
 ...
 */
export declare function buildConversationTranscriptFromMessages(messages: ContinuumVercelAiSdkRouteRequestBody['messages'], maxChars?: number): string | undefined;
/**
 ...
 */
export declare function buildRouteContinuumExecutionContext(body: ContinuumVercelAiSdkRouteRequestBody): ContinuumExecutionContext;
 ...
 */
export declare function serializeContinuumExecutionForObservability(instruction: string, result: ContinuumExecutionFinalResult): ContinuumVercelAiSdkExecutionTraceData;
